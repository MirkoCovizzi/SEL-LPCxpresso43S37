...
__vector_table_0x1c
		...
		DCD		M4_IRQHandler				; 17 M4 IRQ handler (LPC43XX ONLY)
		DCD		DMA_IRQHandler				; 18 General Purpose DMA
		DCD		0							; 19 Reserved
		DCD		FLASH_EEPROM_ATIMER_IRQHandler	; 20 ORed flash bank A, flash bank B, EEPROM and ATIMER interrupts
		...
		DCD		RIT_WDT_IRQHandler			; 27 Ored Repetitive Interrupt Timer, WWDT
		...
		DCD		SPI_DAC_IRQHandler			; 36 ORed SPI, DAC (LPC43XX ONLY)
		DCD		ADC1_IRQHandler				; 37 A/D Converter 1
		DCD		SSP0_SSP1_IRQHandler		; 38 ORed SSP0, SSP1
		DCD		EVRT_IRQHandler				; 39 Event Router
		DCD		UART0_IRQHandler			; 40 UART0
		DCD		UART1_IRQHandler			; 41 UART1
		DCD		UART2_CAN1_IRQHandler		; 42 ORed UART2, C_CAN1
		DCD		UART3_IRQHandler			; 43 UART3
		DCD		I2S0_I2S1_QEI_IRQHandler	; 44 ORed I2S0, I2S1, QEI
		DCD		CAN0_IRQHandler				; 45 C_CAN0
		DCD 	SPIFI_ADCHS_IRQHandler      ; 46 SPIFI OR ADCHS interrupt
		DCD 	M0SUB_IRQHandler            ; 47 M0SUB core
__Vectors_End
...
Reset_Handler
		...
		PUBWEAK	FLASH_EEPROM_ATIMER_IRQHandler
...
M4_IRQHandler
DMA_IRQHandler
FLASH_EEPROM_ATIMER_IRQHandler
ETH_IRQHandler
SDIO_IRQHandler
LCD_IRQHandler
USB0_IRQHandler

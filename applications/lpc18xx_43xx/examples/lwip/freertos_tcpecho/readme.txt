...
Example description
Welcome to the LWIP TCP Echo example with FreeRTOS using the 18xx/43xx LWIP
MAC and PHY drivers.  The example demonstrates PHY link monitoring, DHCP
client, ICMP Echo (ping) and TCP Echo (RFC 862) operation.

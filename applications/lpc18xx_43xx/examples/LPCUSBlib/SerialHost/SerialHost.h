/*
 * @brief Definitions and declarations of Serial Host example
 *
 * @note
...
#ifndef __SERIAL_HOST_H_
#define __SERIAL_HOST_H_
...
/** @defgroup Serial_Host_18xx43xx Serial Host
 * @ingroup EXAMPLES_USB_18XX43XX
 * <b>Example description</b><br>
 * This example implements a CDC class host mode device that enumerates
 * a CDC class device. It reads the first sector

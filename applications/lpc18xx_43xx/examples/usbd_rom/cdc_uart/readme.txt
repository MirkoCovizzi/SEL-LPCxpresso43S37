...
To get the windows driver, install LPC Link2 Configuration Tool from https://www.lpcware.com/lpclink2-config-tool or install LPCExpresso. For OSx (Mac) host no drivers is needed. 
